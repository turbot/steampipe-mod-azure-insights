  ...
  container {
    ...
    graph {
      ...
      edges = [
        ...
        edge.azure_compute_virtual_machine_scale_set_vm_network_interface_to_backend_address_pool_edge,
        edge.azure_compute_virtual_machine_scale_set_vm_network_interface_backend_address_pool_to_lb_edge,
